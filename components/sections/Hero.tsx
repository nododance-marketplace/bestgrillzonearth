  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-shell grid-cols-1 gap-12 px-6 md:grid-cols-12 md:gap-8 md:px-10">
        ...
        <div className="flex flex-col items-start gap-8 md:col-span-7 md:pt-12">
          ...
          >
            ...
            <Image
              ...
              priority
              aria-hidden="true"
              className="h-auto w-full max-w-[640px] select-none drop-shadow-[0_30px_60px_rgba(184,216,232,0.18)]"
            />
          </motion.h1>
        ...
        {/* Right — Globe video loop in circular frame */}
        <motion.div
        ...
        >
          {/* Logo "orbit" — looped globe video at center, breathing pulse rings */}
